...
class RegexTest {
    ...
    void testToMermaidGraph() {
        ...
        assertTrue(mermaidGraph.startsWith("stateDiagram-v2"), "Must start with stateDiagram-v2 declaration");
        ...
        assertTrue(mermaidGraph.contains("--> [*]"), "Must contain at least one exit point for final states");
